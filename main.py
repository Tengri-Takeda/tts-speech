...
def download():
    ...
    if (text):
        if (speed == "Fast"):
            ...
            setvoice()
#icon
image_icon=PhotoImage(file="music_microphone_wireless.png")
...
Logo=PhotoImage(file="music_microphone_wireless.png")
...
imageicon=PhotoImage(file="voice_recorder.png")
...
imageicon2=PhotoImage(file="downloadiru.png")
save=Button(root,compound=LEFT, image=imageicon2, width=130, font="arial 14 bold", command=download)
